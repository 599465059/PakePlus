...
(function() {
  ...
  class App {
    ...
    init() {
      ...
      this.renderPageTabs()
      // 设置默认显示页面管理
      this.currentMenu = '添加控件'  // 默认显示添加控件，方便调试
      this.renderContent()
      ...
      return `
        <div class="panel-split-three">
            ...
            <div class="config-list" id="configList">
              ${configs.length ? configs.map(c => `
                <div class="control-list-item" data-name="${c.name}">
                  ...
                  <div style="font-size:11px;color:#94a3b8;margin-top:4px;">${c.pages}页 · ${c.controls}控件</div>
                </div>
          ...
          <div class="split-section">
            ...
            <button id="btnExportConfig" class="btn-primary" style="width:100%;margin-bottom:10px;">导出并保存</button>
    ...
    bindContentEvents() {
      ...
      if (btnExportConfig) {
        btnExportConfig.addEventListener('click', () => {
          ...
          this.exportAndSaveConfig(name, desc)
        })
      }
